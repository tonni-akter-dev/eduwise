...
class _SignInScreenState extends State<SignInScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    _emailCtrl.value = _emailCtrl.value.copyWith(text: sp.email, selection: TextSelection.collapsed(offset: sp.email.length));
    _passwordCtrl.value = _passwordCtrl.value.copyWith(text: sp.password, selection: TextSelection.collapsed(offset: sp.password.length));
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                padding: EdgeInsets.symmetric(horizontal: width * 0.20), // 20% left & right gap
                child: Center(
                  child: Image.asset(
              ...
              BottomBorderTextField(
                ...
                suffixIcon: IconButton(
                  onPressed: context.read<SignInProvider>().toggleObscurePassword,
                  icon: Icon(
                    sp.obscurePassword ? Icons.visibility_off : Icons.visibility,
                  ...
                  Expanded(
                    child: Row(
                      ...
                      children: [
                        Checkbox(
                          value: sp.rememberMe,
                          onChanged: context.read<SignInProvider>().toggleRememberMe,
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(content: Text('Go to SignUP (UI only)')),
                      );
                    },
                    child: const Text(
                      'SignUP',
